	...
	return (
		<div className="property-project-description">
			<div className="general-description-property-project">
				Applikasjonen lar deg se på ulike fiktive eiendommer, og basert
				på din autorisasjon (3 ulike nivåer) får du informasjon
				tilgjengelig for gjeldende autorisjonsnivå.
				<br />
				<br />
				Som en
				...
				bruker av applikasjonen har du tilgang til ulik informasjon
				basert på autorisjonsnivået. En vanlig bruker kan se informasjon
				som pris, plassering og bilder av eiendommen.
				<br />
				<br />
				En innlogget
				<span style={{ fontStyle: "italic" }}>
				...
				<span style={{ fontStyle: "italic" }}> eiendomsmegler</span> får
				man tilgang til ytterlige informasjon som eier- og
				oppussingshistorikk, samt kontaktinformasjon til eier av
				eiendommen.
			</div>
			<hr />
